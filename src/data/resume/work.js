...
const work = [
  {
    ...
    endDate: '2024-12-31',
    summary: 'Soporte técnico y mantenimiento de sistemas críticos en un entorno de alta exigencia para asegurar la continuidad operativa de la Dirección General de Tráfico.',
    highlights: [
  ...
  },
  {
    ...
    endDate: '2024-06-01',
    summary: 'Experiencia práctica en administración y mantenimiento de sistemas y redes. Participé activamente en la gestión de infraestructuras IT, soporte técnico y documentación para usuarios y sistemas.',
    highlights: [
  ...
  },
  {
    ...
    endDate: '2022-01-31',
    summary: 'Encargado del correcto funcionamiento de sistemas y equipos tecnológicos. Resolución de incidencias, soporte a usuarios, implementación de soluciones técnicas y reparaciones electrónicas en entornos empresariales.',
    highlights: [
